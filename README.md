...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/plotly-ecdf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11447&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/plotly-ecdf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `plotly-ecdf` can be installed with:

```
conda install plotly-ecdf
```

It is possible to list all of the versions of `plotly-ecdf` available on your platform with:
